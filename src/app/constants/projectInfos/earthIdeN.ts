...
export const earthIdeNInfo: MiddleContentsType[] = [
  ...
  },
  {
    ...
    title: "로그인/회원가입 페이지",
    description:
      "사용자 편의를 생각하여 한 페이지에 로그인과 회원가입 기능을 구현하였습니다. 각 섹션 하단의 sign in/up버튼 클릭 시 가림막이 넘어가며, 로그인 또는 회원가입을 할 수 있습니다. 회원가입 성공 시 예시 사진처럼 환영인사가 뜨고 자동으로 왼쪽 로그인 섹션으로 넘어갑니다.",
  },
  {
    image: image5,
